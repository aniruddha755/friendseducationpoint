...
// Clone theme toggle for mobile menu
if (themeToggleBtn && navLinks && !document.getElementById('theme-toggle-mobile')) {
    ...
    mobileThemeToggle.classList.remove('icon-btn');
    
    // Create text span
    const textSpan = document.createElement('span');
    textSpan.textContent = 'Toggle Theme';
    mobileThemeToggle.appendChild(textSpan);
    
    navLinks.appendChild(mobileThemeToggle);
